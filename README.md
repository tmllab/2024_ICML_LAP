...
[![Paper](https://img.shields.io/badge/paper-ICML-green)](https://openreview.net/pdf?id=m8lCi7rG4u.pdf)

</div>

Official implementation of [Layer-Aware Analysis of Catastrophic Overfitting: Revealing the Pseudo-Robust Shortcut Dependency](https://openreview.net/pdf?id=m8lCi7rG4u.pdf) (ICML 2024).
